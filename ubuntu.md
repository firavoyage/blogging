...
# usage: fd . --maxdepth 2 # alias fd to fdfind on zshrc
...
pnpm add -g tsx
pnpm add -g node-srv # for static pre built html
# usage: node-srv -l -i foo.html -p 8000
...
- install extensions
  ...
  - enhance new tab: intention <!-- repo: f: intention. load unpacked with dev mode on. -->
    ...
    - intention settings: url to open when enter is empty `https://claude.ai` <!-- https://chatgpt.com --> <!-- `https://chatgpt.com/branch/69a713fd-5b58-83a3-958e-c38e92cffc74/4bccd054-037e-4707-88ff-4be087bb475e` --> <!-- use the latest one -->
  ...
  - enhance youtube: picture in picture https://chromewebstore.google.com/detail/picture-in-picture-extens/hkgfoiooedgoejojocmhlaklaeopbecg
  - enhance youtube: unhook https://chromewebstore.google.com/detail/unhook-remove-youtube-rec/khncfooichmfjbepaaaebmommgaepoid
...
# sudo dpkg -i "$codex_file" # broken, wrong compilation target resulting in missing bindings
