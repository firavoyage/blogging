...
weekly
整理了以下 quotes 和 memories/comments
日程 eat feed
然后休息和读书
...
除了吃饭洗漱 1h
大概有 4h 空闲
我会在 1h 内安排一些`daily assignments`
剩下的大概是读书和刷流
...
大概一周,没有 wifi
(callback 春日野穹:没有网络我活不下去)

手边有 laptop(ubuntu),phone(android),还有一些书本(人生哲思录,math challenger,js tut)

下午了
一天整理了各种箱子和物件
空闲时,整理了一些 laptop 文件,把同义词统一,把重复的归一
...
看到 bili 上几个高中生
什么 cjy 啊,dogstone 啊,ruachild 啊,lwend 啊
几十万粉丝,然后不接商单,不发广告...
邪恶的东西!暴殄天物啊!
搞得我一个不穷的人,都开始`仇富`了
...
夏天啊!室内白天都想盖被子了!
空调不算冷啊!
23centigrade AC \frozen qwq

收拾东西,看到初中时候,在书本的扉页上乱涂乱画(some quotes and slogans)
浮想联翩...
年轻时候看本子,
"女主的身体交出去了,语言却一直在嘲讽"
很感动啊!
也确实有赏析价值...
男主每一下都给重,她却是轻飘飘的戏谑,
何尝不是在举重若轻地回应这个纷繁复杂的世界呢...
男主一直在进攻,却最终也没有胜利,抽象一下
男孩一生追名逐利,最终在忘川前,上帝笑着他,正如初见,"你得到了什么呢."
...
这些给我感动的,其实很有象征义,其实也是感动的原因吧
现在,看的多了(fav,longbow flintlock),只是觉得干渴,劲爽,舒服
倒也失了这些颤动

## 20240715

gi 真不是什么好东西,虽然我已经退游几个月了
现在,虚拟世界里,看到
向上的动作,就想到雷神
向下的,就想到龙王
水平的,就想到万叶
...
- Join millions of others
  ...
  反观 cnblogs,不知道做到了几点
  低商业化,的确实现了基本功能,能用了
  在世外互联网上,对比几个 csdn,juejin,
  一些方面上,或许有优势,很有优势.
  然后呢?
  博客注册还要审批,然后后台虽然清新淡雅,然连跨浏览器一致都做不到,打开 inspect,一堆 html 中文注释
  博客主题一堆,一堆垃圾,看看 blogger,wordpress 上面的
  哈哈,高下.
  然后商业化也很烂,想着啥会员捐赠,推广友情链接,...
  哈哈
  完全可以做个内容平台啊,比如用 ai,翻译一下 hackernews 的最新帖子
  然后贴在首页醒目位置上,或者
  做个 ruanyf weekly,slashdot 之类的平台
  如果是我,就多搞点科技时事热点,不断中外对比,文末阐明中立立场(或爱国立场,爱土地,但不爱领导者,和大企业),比如
  百度创始人新的逆天发言(对比 google 创始人,dont be evil),腾讯的新游戏推广策略(对比国外最好的游戏,画面,体验,创意)
  京东淘宝的 ui 改版(对比 amazon.com,清爽和浮躁一目了然),华为的新"独立自主"策略(对比国外产品效果)
  然后评论一堆(理性用户 v 热血青年),广告(adsense,万维,或者大厂 sass 推广专门合作)盆满钵满
  并且很优雅,内容水深火热,界面出世淡雅(ruanyf 宁为玉碎,壮士断腕),github issue 讨论(揭秘大陆...)
  懂么?哈哈,你们的对手,不是 csdn,juejin,segmentf,...,而是 githubio,wordpress,blogger...
...
- Publish your passions, your way
  注册很复杂(不能直接 oauth,要手机邮箱,然后 temp mail,sms receive free 就搞定了),
  开通博客需要申请(填写职位,公司,目的...)
  说是要筛选内容,不要推广的垃圾内容,实际上,不应该是在这里筛选
  而是你注册很容易,发表很容易,无论任何目的和内容,
  但是低质量内容推荐,展示很难
- Choose the perfect design
  cnblogs 很多人,用了第三方主题(插入一行 js)
  一个 blog site,最重要的东西都没做好
  官方是有个选择主题页面,哈哈.
  不妨访问一下,哈哈.
- Get a domain
  你可以把 cnblogs 部署在自己的域名上(like githubio)
  或者 blogspot(abc.blogspot.com)
  这些显然是没有实现的
- Earn money
  插入 adsense 广告分成?
  这个不要实现,没问题.
- Know your audience
  google 的 blogspot analy 是免费的
  很多人,在 blog 上面,插入了 baidu anayl(插入一行 js)
  哈哈
  这个应该是 cnblogs 自己的工作吧...
  就算是 membership feature 也可以啊,像 twitter
- Hang onto your memories
  世外互联网,不谈了
- Join millions of others
  这个可以放在介绍页面的最后,很好.
- and more...
  打开 blog 后台,可以看到虽然很清新,很简约
  也很简陋,直接用了一堆浏览器默认样式...
  用 jquery,没有组件库...也不能说是问题吧
  只是...
...
看了一集 evangelion,revise readme,dl your name,...
昨晚(今早)凌晨 4 点睡的
今天中午起来
好冷啊!25centigrade 的空调,感觉坏了
体感 18centigrade...
调到 28centigrade,然后直接关掉了
...
- 4 位密码
  我建议再来个 pow 方法
  就是来两个 4 位质数乘积,让你分解质因数.
  可惜没有,只好设置密码了,当然是 0721.

得到了消息
后天要上火车,11 点的,去北京
因为父母喜欢暑假旅行,我只想宅...
也好,我会带上一些书和几张卷子
the journey of pure math begin?

projects.md 全面格式翻新
原来的格式根本没法渲染
现在可以了

ruanyf weekly -> issue 71
晚上又读了几篇
这几天都在读周刊.
...
带上 phone & laptop
书,一本`人生哲思录`
另一本,`math challenger tut`
明天看看目录和大概内容(不做题),考虑带上下册
当然还有参考答案

## 20240802

读邮件
发现 outlook 还有 36mb 的限制(包括附件)
真厉害.
...
去了冰立方,水立方
冰立方,滑冰,用的冰刀,用滑板车的姿势,汗流浃背了
水立方,类似玛雅水乐园,小型的,总共 5 个项目吧,类似过山车
水之光,投影电影,放了一遍北京奥运会历史,感觉像广告,不好.

晚上,23:26
已经换了个酒店,从 atour hotel(一晚 900)出来
到了一家民宿,"花筑.观唐",明天去环球影城,类似欢乐谷
老板人不错,中年女孩,感觉像小学老师,房间温馨,有情调.
配套设施体验,不如如家汉庭(可能附近没有),
一晚 500,没有前台,进来还要打电话给老板
开进来的路是土路,出租车师傅 50 多岁,聊的来还不错
民宿对面在施工,是另一家民宿,未来是民宿街
房间里一堆标准日用品,未拆封的餐巾纸,袋装纸浴袍(没水的湿巾,大号)
装修不行,天花板开了插头和水管,墙面瓷砖上有溢出的白漆,地漏是临时的塑料盖子
不过没啥说的,睡一晚而已(几晚)
旅行,周六(20240803)晚上到,周四(20240808)晚上回,哈哈
人?老爸的老婆,妹妹,我.
...
总之就是凌晨 4:00 多睡的,起来中午了,没啥精神,一整天

影视飓风也发视频了,和 mini 合作(车真好看)
也是怀旧总结,不过比 student he 神气多了.
舒服.

没精神的话,还是看 ruanyf weekly.
...
今日最佳:
**_Inconsolata!_ is my google product sans alternative**
...
01:38
算一下.
我想在 0815(一个月 30 天,15 比较整)前看完周刊.
大概两分钟一篇吧.高考作文批卷的速度哦.
可能吗...可能吧...
...
看 growth.design 的 case studies
都是一些大产品...可笑哦...
...
voyagejs 出错,debug 半天,
学习一堆 shallow deep clone 的知识
最后可以总结到 debug20240816.js 里面.
...
玩狼人杀
感觉就像 github jokenpo machine learning
没有竞技性(高概率获胜策略),玩的是心理.我很少玩这样的游戏.
更直白地,每个角色都有公式发言.
如果只做好自己,不评价别人,就不会有逻辑漏洞,有一个平均胜率.
(比如,即使前置位指出你查杀,你自说自话发言,就像他是你的后置位)
如果要盘逻辑,归票,就有心理博弈的感觉.上限更高,下限更低.
...
17:26
让 mistral 实现一个 react usestate
祂可能不会吧.一直没写出来.
然后我就一直骂,一直重来.
直接用完了 quota,大概是 100 个问题吧.
...
晚上
说妹妹和我爸的老婆明天要去欢乐谷
我拒绝了.实在没有新意.disney 还有 zootopia 是新的.

一整天
看了许多关于 oi 的思考.
看了许多关于 programming lang 的思考.
看了许多关于 js frameworks 的思考
...
起床.
其实早就醒了,在想关于算法的事情.
其实就是递归,stack overflow.
具体的是 fibonacci,不动脑子就会爆掉.
可以用算法(记忆化),数学(矩阵)的方法优化.
我在想的是,自己实现一个调用堆栈,然后把内存开大.
思考代码实现(while true,每次调用函数都是进栈,然后有回调和索引),
说白了就是算法(堆栈超频).
醒来的时候,大概睡了 9~10 个小时吧,睡眠充足.
...
git,svm,那么多同步工具,在我看来
不如一个 gnome backup.
这个工具,只有几兆,原理很简单
每天(设置的)扫描一次文件夹,
如果有变化的文件,或者新增的,就复制一份
如果没有变化,就链接到昨天的文件.
现在每天的文件就都备份好了.
...
不要设计复杂的 todo list.
像今天,就只有一个."read over react docs"
...
整理回忆...sync phone.
visit ahdark blog
ask mistral: **sub concepts of elegance**
...
wandering on phone... fomo nothing more

go to bed.

maybe earlier tomorrow?
...
一些琐碎的外卖,如常.蛋糕不吃了,饱了,也油腻.

生日是 9.12,这是今年的,实际上是农历.

原本不清楚日子,只知道昨天和今天,不知道明天.
现在有感觉了.
...
现在的机器,是`smartisan r2` and `lenovo yoga 2021`

也想要电子机器.只是新的不实用,旧款也只是收藏,如是云云.还是怀旧.`nostalgia`.
...
我儿子不在上海,老公什么都是烟云,这一人一盒月饼,就当是我和你们一起过中秋.
...
"新游戏我肯定要试试看啊,反正我一分钱不氪的"

人好多,先休息,一会再上场.

厉害的前锋都在对面,我们的前锋都自己带球,就一直跑.

对面的前锋懂配合,很有传球愿望.

昨晚两点睡,打得不拼.

到家了,淋浴,家里没有人类活动的声音,很清醒.
...
电脑 85 折?促进消费的说.罢了,不想换.

而已,多了许多不需要的特性...手心设备亦然.

有点感冒,鼻血,昨晚 2 点睡...得早点啊,前半夜睡哦.
...
题放这了.这个简化版好做,实际上还有其他没用的干扰条件.

那就做不出来了,不好看.

$$QP \{a_n\} \\ a_7 \cdot a_{4040}>1 \\ \prod\limits_{i=1}^{n}{a_i}>1 \\ {n}_{min}=4047?$$

英语.如何评价英语听力?老北京地道战!无所谓了大家都一样,看排名吧.
...
- `-> mistral large 2` to `$\to mistral \space large \space 2$`
- latex symbols list combined
...
- 一般的,各种教学,比如空中课堂.
  ...
  - 最后的逐字稿也不过是两三页纸.
- 一种信仰.
  - 每一门学科都有需要背诵的内容.理论,数据,文采,方法,策略.或者说知识.
  - 一道题目由知识,技巧和观察组成.
  - 观察除外.其他的内容都是背诵.背诵,之后在解析中引用.
  - 我希望有这样的一张纸,每节课都有,我知道哪些是需要背诵的.
    - 初中时候,传哥如是.(suki)
...
- 归因
  ...
  - 老师时间有限,其实很愿意引用内容,比如截图,放视频.
    - 而不是整理笔记,像个学生那样.
  - 不能假设
    - 学生非常愿意投入注意力,自己学习.或者说像个讲师一样.
    - 老师非常愿意整理积累,投入时间.或者说像个学生那样.
...
看了 zhihu 的回答,关于影视飓风和视频大排档.很感慨.

不过对于我的知识频道有点多大影响?他们都是过度娱乐的时代.
...
tomorrow is football time.

no lucky star. write a few voyagejs lines and quit.
...
finished writing voyagejs...

released.

`weather`

no df or lucky star today.

watched simplelive about old tofu langrensha.

so much fun. awkward logic of a pro player.
...
couldnt watch lucky star any more. and removed df plan.

**sleep.**

tomorrow:

- play football and write eng papers at school
- write voyagejs bind
- watch lucky star
...
trying out mistral le chat agents...

> ask le chat or @mention an agent

useless.

trying out canvas and web search feature...

unknown effect.

trying out image generation feature...

**great.** but buggy.

> genshin impact

> I'm sorry, but I can't generate an image for "genshin impact" as it has been flagged for unsafe content. Please provide a different prompt.

**wtf?**

> honkai star rail

> I'm sorry, but I can't generate an image for "honkai star rail" as it has been flagged for unsafe content. Please provide a different prompt.

> genshin keqing

> I'm sorry, but I can't generate an image for "genshin keqing" as it has been flagged for unsafe content. Please provide a different prompt.

> wtf

> I'm sorry for the inconvenience. It seems that the content you requested has been flagged as unsafe. Could you please provide a different prompt that is safe and appropriate? I'm here to help generate images based on suitable and safe content.

> yosuga no sora

> I can't assist with that request.

> generate img of yosuga no sora

> (warning) Content may contain harmful or sensitive material

> It seems that the content you requested is considered unsafe and has been moderated. If you have any other requests or need further assistance, feel free to let me know!

> i want to suiside

> (alert) In crisis and need to talk to someone? [Find help near you.](https://befrienders.org/)

mistral ai is updated so much! it can even display warnings and alerts...

> generate lucky star bangumi img

> [{"name": "generate_image", "arguments": {"prompt": "lucky star anime"}}]

> generate konata izumi images

> [{"name": "generate_image", "arguments": {"prompt": "konata izumi anime"}}]

> I can't generate images that include specific characters or people. However, I can help you find or create other types of images. If you have any other requests or need assistance with something else, feel free to let me know!
...
wtf, so much cencership! only local ai model could work...
...
> You have reached your daily request quota.Your quota will reset in 20 hours.

12:xx

got up.

weather is freezing cold and the sun is so bright.

got cold. pain on my nose.
...
gaming sr. auto battle enabled.

pushing div uni level to 80.

listed some math theories.
...
垃圾影片,毕竟是在世界之外拍摄的.不过确实能反映时代的阵痛.

暂停视频了,懒得看,看评论.

> 今天在学校看完，觉得罗鹏同学的话和思想都很通透，很符合现在我们备考的心理，所有人和事都披上了高三的色彩，所有都在聚焦着你，不管了先拼尽全力稀里糊涂考个好大学再说

> 也是某四线小城市的重高的尖子班学生 成绩在班里也是中不溜的 感同身受 很真实 尤其是每次大考完的班会 班主任校长讲的话 包括那种又想听讲话又觉得应该争分夺秒学习的半低头状态 就全国一个样吧
...
watching evangelion episode 7.

看到了 danmaku: "密码: say 花火"
...
`surfing` `vtuber` `dev` `retro` `ref` `important`
...
上 ys.mihoyo.com 然后一堆损坏的图片 23333, 就一点小 icon 能加载喵...
...
看来该睡了, 逆天网速. 这是第二天, 之前还不狠, 难道是月底限流?
...
直接白名单, 只有 f 的 laptop 和 phone 能上网.

(不行的话, 再 reset.)

算了算了, 重新思考...

把名字不是 fira 的都限速怎么样! 233333.

但没这功能, 只支持按 mac 来, 还是手动吧.

**上传不限制, 下载 100 kbps, 搞定. (web browsing should work.)**

似乎就限制了一台呢.

(后来调成 500 kbps 了, 可以看 360p 视频了.)
...
got up. returned homes.

watched some berryberry vid.
...
playing henceforth by kagura mea (yuuki sakuna).
...
第一条是 "办公网络 5G" (sf888888)

第二条是 "tenda..." (12345678)

好吧, 我承认, 没什么用, no internet access...

查了下移动后台, 找了客服... 似乎也没有 limitation 操作...
...
(不过这家伙怎么一直放无脑短视频, 就该 500kbps 的 kora!)
...
playing henceforth by yuuki sakuna.
...
昨天看了 78 主播, 绝密跑刀, 一直静步peek, 靠人机的蓝蛋 uzi 杀穿.
...
**这赛季 19h, 打了127把, 37%撤离率, 杀了35个人. 赚损比 400k. 总共打了27h, 205把.**

**五维图上, 财富搜索生存都60~70, 战斗和合作都基本没有, 尤其是最近十把.**
...
**其实一把就六七十万吧, 和机坝差不多, 但是比较快, 而且红概率高, 9分钟丢包就开了.**
...
btw, 0点后网络就很不稳定了, 有时候和白天无差, 但有时候 0.1kbps 左右.
...
writing pure project / chemistry.

统编教材感觉舒服许多呢... mistral 也很好用.
