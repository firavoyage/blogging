(function () {
  ...
  require.register("vue/src/emitter.js", function (exports, require, module) {
    ...
    try {
      ...
      Emitter.prototype.off = function () {
        var method =
          arguments.length > 1 ? this.removeListener : this.removeAllListeners;
  ...
  require.register("vue/src/compiler.js", function (exports, require, module) {
    ...
    CompilerProto.compile = function (node, root) {
      ...
      if (node.nodeType === 1) {
        ...
        var repeatExp,
          componentId,
          partialId,
          customElementFn = compiler.getOption(
            "elements",
    ...
    CompilerProto.bindDirective = function (directive) {
      ...
      if (directive.isExp) {
        ...
        binding =
          ownerCompiler.bindings[key] ||
          compiler.rootCompiler.createBinding(key);
      }
    ...
    CompilerProto.createBinding = function (key, isExp, isFn) {
      ...
      if (isExp) {
        ...
        if (getter) {
          ...
          binding.value = isFn ? getter : { $get: getter };
    ...
    CompilerProto.destroy = function () {
      ...
      if (parent) {
        parent.childCompilers.splice(
          parent.childCompilers.indexOf(compiler),
          1
        );
        if (childId) {
  ...
  require.register("vue/src/directive.js", function (exports, require, module) {
    ...
    Directive.parse = function (dirname, expression, compiler, node) {
      ...
      var dir =
        compiler.getOption("directives", dirname) || directives[dirname];
  ...
  require.register(
    ...
    function (exports, require, module) {
      ...
      var KEYWORDS =
          ...
          ",Math",
        KEYWORDS_RE = new RegExp(
          ["\\b" + KEYWORDS.replace(/,/g, "\\b|\\b") + "\\b"].join("|"),
          "g"
        ),
        REMOVE_RE =
          /\/\*(?:.|\n)*?\*\/|\/\/[^\n]*\n|\/\/[^\n]*$|'[^']*'|"[^"]*"|[\s\t\n]*\.[\s\t\n]*[$\w\.]+/g,
      ...
      function getRel(path, compiler) {
        var rel = "",
          vm = compiler.vm,
          dot = path.indexOf("."),
          key = dot > -1 ? path.slice(0, dot) : path;
        while (true) {
        ...
        if (!hasOwn.call(compiler.bindings, path) && path.charAt(0) !== "$") {
  ...
  require.register(
    ...
    function (exports, require, module) {
       ...
       *    2 = leave
       */
      var transition = (module.exports = function (
        el,
        stage,
        changeState,
        compiler
      ...
      function applyTransitionFunctions(
        el,
        stage,
        changeState,
        functionId,
    ...
    function (exports, require, module) {
      ...
      module.exports = {
        ...
        update: function (value) {
          ...
          if (!this.parent) {
            // the node was detached when bound
            if (!el.parentNode) {
              return;
            } else {
    ...
    function (exports, require, module) {
      ...
      module.exports = {
        bind: function () {
          ...
          self.ChildVM =
            self.compiler.getOption("components", componentId) || ViewModel;

          // extract transition information
          self.hasTrans = el.hasAttribute(config.attrs.transition);

          // create a comment node as a reference node for DOM insertions
          self.ref = document.createComment(
            config.prefix + "-repeat-" + self.arg
          );
