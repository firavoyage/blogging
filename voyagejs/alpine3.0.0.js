  ...
  function onMutate(mutations) {
    ...
    for (let node of removedNodes) {
      ...
      if (onAttributeRemoveds.has(node)) {
        Object.entries(onAttributeRemoveds.get(node)).forEach(
          ([key, value]) => {
            value.forEach((i) => i());
          }
        );
  ...
  function interceptor(callback, mutateFunc = () => {}) {
    return (initialValue) => {
      function func(key, path) {
        ...
        let store2 =
          parentInitialValue === void 0 ? initialValue : parentInitialValue;
        ...
        let setup = (context) => {
          if (inited) return;
          parentIniter.bind(context)(
            store2,
            setValue,
            reactiveSetValue.bind(context)
          );
          initer.bind(context)(
            store2,
            setValue,
        ...
        return [
          {
            ...
            set(value) {
              setup(this);
              parentSetter.bind(this)(
                value,
                setValue,
                reactiveSetValue.bind(this)
              );
...
`,
  ...
  directive("cloak", (el) =>
    nextTick(() => mutateDom(() => el.removeAttribute(prefix("cloak"))))
  );
